...
export class UsersController {
      ...
      return {
        ...
        data: {
          ...
          usage: {
            ...
            limits: {
              dailyDocs: user.subscriptionStatus === 'premium' ? 30 : user.subscriptionStatus === 'pro' ? 15 : 5,
              dailyMessages: user.subscriptionStatus === 'premium' ? 45 : user.subscriptionStatus === 'pro' ? 30 : 20,
            },
          },
        },
      };
  ...
  async buyFreeze(@Req() req: any) {
    ...
    return {
      success: true,
      data: { freezes: user.streakFreezes, points: user.points },
    };
  }
